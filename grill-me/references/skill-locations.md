...
| **comms-hub-skills** | `~/Documents/Claude/Skills/comms-hub-skills/` | ea-hub, ea-outreach-email, ea-outreach-followup, ea-calendar-invite, ea-admin-tasks, ea-reimbursement, ea-mentee-scaffolding, ea-signature-stamp, ea-inbox-triage | install.sh + .skill UI register |
